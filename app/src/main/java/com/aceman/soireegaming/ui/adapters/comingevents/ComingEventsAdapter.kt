 ...
 *
 * Adapter who shows the events in ComingEvents.
 */
class ComingEventsAdapter(var eventList: List<EventInfos>, val listener: (String) -> Unit) : RecyclerView.Adapter<ComingEventsViewHolder>() {

 ...
 */
class EventDetailAdapter(var userList: MutableList<User>, var isOwner: Boolean, val listener: (String, String) -> Unit) : RecyclerView.Adapter<EventDetailViewHolder>() {
    ...
    override fun onBindViewHolder(holder: EventDetailViewHolder, position: Int) {
        holder.updateWithItem(this.userList[position], position, listener, isOwner)
